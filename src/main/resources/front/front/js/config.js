...
var centerMenu = [
    ...
    ,{
        name: '预约项目收藏',
        url: '../fanzhashipinCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '反诈视频',
        url: './pages/fanzhashipin/list.html'
    },
    {
        name: '论坛',
...
var adminurl =  "http://localhost:8080/fanzhapingtai/admin/dist/index.html#/login";
