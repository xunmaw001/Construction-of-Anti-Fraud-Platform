...
public class FanzhashipinLiuyanView extends FanzhashipinLiuyanEntity implements Serializable {
	...
	public FanzhashipinLiuyanView() {

	}

	public FanzhashipinLiuyanView(FanzhashipinLiuyanEntity fanzhashipinLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, fanzhashipinLiuyanEntity);
